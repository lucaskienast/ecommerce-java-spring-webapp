...
insert into passport (id, number)
values (30002, 'B987654');

insert into passport (id, number)
values (30003, 'C192837');


insert into student (id, name, passport_id)
values (20001, 'Lucas', 30001);

insert into student (id, name, passport_id)
values (20002, 'Max', 30002);

insert into student (id, name, passport_id)
values (20003, 'Jim', 30003);


insert into review (id, rating, description, course_id)
values (40001, 'THREE', 'OK review', 10002);

insert into review (id, rating, description, course_id)
values (40002, 'FIVE', 'Excellent review', 10002);

insert into review (id, rating, description, course_id)
values (40003, 'TWO', 'Bad review', 10003);
